...
Once worktree is enabled in Phase 3, prefix any agent invocation that operates in the worktree (`do-develop`, `do-frontend`, `do-reviewer`, `spec-code-reviewer`, `spec-tester`) with `DO_WORKTREE_DIR=<worktree_dir>`.
...
Phase 3: Implementation
    ...
    |  -> Generate summary.md
    |  -> Code review via do-reviewer + spec-code-reviewer (parallel dual review)
    |  -> BLOCKING issues? fix then re-review (max 3 iterations)
